export type ExamType = 'takken' | 'land-surveyor' | 'real-estate-appraiser' | 'rental-property-manager' | 'condominium-manager' | 'web-design-3' | 'go' | 'python' | 'python-data-analysis' | 'statistics-grade2';
